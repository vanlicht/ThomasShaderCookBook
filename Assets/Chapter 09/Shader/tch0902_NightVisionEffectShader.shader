Shader "Custom/tch0902_NightVisionEffectShader" 
{
	Properties 
	{
		...
		_RandomValue("Random Value", Float) = 0.1
		_distortion("Distortion", Float) = 0.2
		_scale("Scale (Zoon)", Float) = 0.8
	}
	SubShader
	{
		Pass
		{
			...
			fixed4 frag(v2f_img i) : COLOR
			{
				...
				//get the lumniosity values from the render texture using the YIQ values
